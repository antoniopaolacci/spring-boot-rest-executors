...
public class BufferedLoggingInterceptor implements ClientHttpRequestInterceptor {

	private static Logger log = LoggerFactory.getLogger(BufferedLoggingInterceptor.class);
    ...
    private void logRequest(int requestNumber, HttpRequest request, byte[] body) {
    	...
    	if (log.isDebugEnabled()) {
            ...
            if (body.length > 0) {
                log.debug("{} Body: {}", prefix, new String(body, StandardCharsets.UTF_8));
            }
        }
